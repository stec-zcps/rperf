...
- [`Style Guidelines`](https://doc.rust-lang.org/1.0.0/style/) have to be considered
...
- `docs-*` for documentation updates (or similar documents)
...
Please add comments to your code changes.__
...
Editor Suggestion:
- [IntellijJ Rust](https://www.jetbrains.com/de-de/rust/)
- Visual Studio Code with [Rust Extension](https://marketplace.visualstudio.com/items?itemName=rust-lang.rust)
...
If you have made some code changes, be aware of the Rust [Style Guidelines](https://doc.rust-lang.org/1.0.0/style/)
. After you have build code, check for new Rust style issues. They are shown as warnings.
